...
Route::middleware([
    ...
    Route::group(['prefix' => 'dashboard'], function () {
        ...
        Route::get('/myOffers/made', [OfferController::class, 'offersMade'])->name('offers.made');        
        Route::get('/myOffers/received', [OfferController::class, 'offersReceived'])->name('offers.received');
