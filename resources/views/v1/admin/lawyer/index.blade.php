...
@section('content')
    ...
    <div class="page-header d-flex align-items-center justify-content-between border-bottom mb-4">
        <h1 class="page-title">Advogados</h1>
        <div>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0);">Gerenciar Advogados</a></li>
                <li class="breadcrumb-item active" aria-current="page">Advogado</li>
            </ol>
        </div>
    </div>
    <!-- PAGE-HEADER END -->
            ...
            <div class="col-xl-12">
                <div class="card custom-card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="d-flex">
                            <a href="{{ route('lawyer.create') }}" class="btn btn-primary btn-block float-end my-2"><i
                                    class="fa fa-plus-square me-2"></i>Adicionar Advogado</a>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($lawyers as $lawyer)
                                        <tr>
                                            <td>{{ $lawyer->name }}</td>
                                            <td>{{ $lawyer->title }}</td>
                                            <td>{{ $lawyer->OAB_number }}</td>
                                            <td>{{ $lawyer->UF }}</td>
                                            <td>{{ $lawyer->created_at }}</td>
                                            <td class="align-middle">
                                                <div class="btn-list">
                                                    <a href="{{ route('lawyer.show', ['lawyer' => $lawyer->id]) }}">
