					...
					<div class="main-header-container container-fluid">
						...
						<div class="header-content-left align-items-center">
							...
							<div class="main-header-center  d-none d-lg-block  header-link">
								<input type="text" class="form-control" id="typehead" placeholder="Buscar..."
									autocomplete="off">
									...
									<div class="py-3 border-top px-0">
										<div class="text-center">
											<a href="javascript:void(0);"
												class="text-primary text-decoration-underline fs-15">Ver tudo </a>
										</div>
									</div>
								</div>
							</div>
										...
										<div class="header-element main-profile-user">
											...
											<ul class="dropdown-menu pt-0 overflow-hidden dropdown-menu-end mt-1"
												...
												<li><a class="dropdown-item" href="{{url('dashboard')}}"><i
															class="ti ti-inbox fs-18 me-2 op-7"></i>Painel</a></li>
												
												
												<li><a class="dropdown-item border-block-end" href="{{url('faq')}}"><i
															class="ti ti-help fs-18 me-2 op-7"></i>Suporte</a></li>
												<li>
												...
												<li class="d-flex justify-content-center p-2">
													<span><a class="fs-12 px-2 border-end"
															href="javascript:void(0);">Politica de privacidade</a></span>
