                            ...
                            <div class="col-xl-2 col-lg-12">
                                <a href="javascript:void(0);" class="btn btn-primary btn-block float-end my-2"
                                    data-bs-toggle="modal" data-bs-target="#add-user"><i
                                        class="fa fa-plus-square me-2"></i>Add User</a>
                                    ...
                                    <tbody>
                                        <tr class="user-list">
                                            <td class="align-middle text-center user-checkbox">
                                                <div
                                                    class="custom-control custom-control-inline custom-checkbox custom-control-nameless m-0 align-top">
                                                    <input class="custom-control-input" id="user1" type="checkbox"
                                        ...
                                        <tr class="user-list">
                                            <td class="align-middle text-center user-checkbox">
                                                <div
                                                    class="custom-control custom-control-inline custom-checkbox custom-control-nameless m-0 align-top">
                                                    <input class="custom-control-input" id="user2" type="checkbox">
                                        ...
                                        <tr class="user-list">
                                            <td class="align-middle text-center user-checkbox">
                                                <div
                                                    class="custom-control custom-control-inline custom-checkbox custom-control-nameless m-0 align-top">
                                                    <input class="custom-control-input" id="user3" type="checkbox">
                                        ...
                                        <tr class="user-list">
                                            <td class="align-middle text-center user-checkbox">
                                                <div
                                                    class="custom-control custom-control-inline custom-checkbox custom-control-nameless m-0 align-top">
                                                    <input class="custom-control-input" id="user4" type="checkbox"
                                                        checked> <label class="custom-control-label"
                                                        for="user4"></label>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="user-list">
                                            <td class="align-middle text-center user-checkbox">
                                                <div
                                                    class="custom-control custom-control-inline custom-checkbox custom-control-nameless m-0 align-top">
                                                    <input class="custom-control-input" id="user5" type="checkbox">
                                        ...
                                        <tr class="user-list">
                                            <td class="align-middle text-center user-checkbox">
                                                <div
                                                    class="custom-control custom-control-inline custom-checkbox custom-control-nameless m-0 align-top">
                                                    <input class="custom-control-input" id="user6" type="checkbox">
                                        ...
                                        <tr class="user-list">
                                            <td class="align-middle text-center user-checkbox">
                                                <div
                                                    class="custom-control custom-control-inline custom-checkbox custom-control-nameless m-0 align-top">
                                                    <input class="custom-control-input" id="user7" type="checkbox">
                                        ...
                                        <tr class="user-list">
                                            <td class="align-middle text-center user-checkbox">
                                                <div
                                                    class="custom-control custom-control-inline custom-checkbox custom-control-nameless m-0 align-top">
                                                    <input class="custom-control-input" id="user8" type="checkbox"
                                                        checked> <label class="custom-control-label"
                                                        for="user8"></label>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="user-list">
                                            <td class="align-middle text-center user-checkbox">
                                                <div
                                                    class="custom-control custom-control-inline custom-checkbox custom-control-nameless m-0 align-top">
                                                    <input class="custom-control-input" id="user9" type="checkbox">
                                        ...
                                        <tr class="user-list">
                                            <td class="align-middle text-center user-checkbox">
                                                <div
                                                    class="custom-control custom-control-inline custom-checkbox custom-control-nameless m-0 align-top">
                                                    <input class="custom-control-input" id="user10" type="checkbox">
                                                    <label class="custom-control-label" for="user10"></label>
                                                </div>
                                            </td>
                                            <td class="align-middle text-center">
                                                <div class="d-flex align-items-center flex-wrap gap-1">
                                        ...
                                        <tr class="user-list">
                                            <td class="align-middle text-center user-checkbox">
                                                <div
                                                    class="custom-control custom-control-inline custom-checkbox custom-control-nameless m-0 align-top">
                                                    <input class="custom-control-input" id="user11" type="checkbox">
                                                    <label class="custom-control-label" for="user11"></label>
                                                </div>
                                            </td>
                                            <td class="align-middle text-center">
                                                <div class="d-flex align-items-center flex-wrap gap-1">
                                        ...
                                        <tr class="user-list">
                                            <td class="align-middle text-center user-checkbox">
                                                <div
                                                    class="custom-control custom-control-inline custom-checkbox custom-control-nameless m-0 align-top">
                                                    <input class="custom-control-input" id="user12" type="checkbox"
                                                        checked> <label class="custom-control-label"
                                                        for="user12"></label>
                                                </div>
                                            </td>
                                ...
                                <div class="card-body text-center">
                                    <div class="text-center">
                                        <div class="dropdown text-end">
                                            <a href="javascript:;" class="option-dots text-muted"
