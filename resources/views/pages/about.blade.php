                    ...
                    <div class="card mt-5">
                        <div class="card-body">
                            <div class="text-center mt-4">
                                <div class="team-img">
                                    <img src="{{ asset('build/assets/images/users/11.jpg') }}" class="rounded-circle"
                                        alt="img">
                                </div>
                            </div>
                        ...
                        <div class="card-footer py-3">
                            <div class="text-center">
                                <div class="d-flex justify-content-center">
                                    ...
                                    <button type="button" class="btn btn-icon btn-danger-light rounded-pill ms-2"><i
                                            class="fa fa-instagram"></i></button>
                                    <button type="button" class="btn btn-icon btn-info-light rounded-pill ms-2"><i
                ...
                <div class="col-xl-3">
                    <div class="card mt-5">
                        <div class="card-body">
                            <div class="text-center mt-4">
                                <div class="team-img">
                                    <img src="{{ asset('build/assets/images/users/18.jpg') }}" class="rounded-circle"
                                        alt="img">
                                </div>
                            </div>
                            <div class="text-center mt-2">
                ...
                <div class="col-xl-3">
                    <div class="card mt-5">
                        <div class="card-body">
                            <div class="text-center mt-4">
                                <div class="team-img">
                                    <img src="{{ asset('build/assets/images/users/7.jpg') }}" class="rounded-circle"
                                        alt="img">
                                </div>
                            </div>
                            <div class="text-center mt-2">
                ...
                <div class="col-xl-3">
                    <div class="card mt-5">
                        <div class="card-body">
                            <div class="text-center mt-4">
                                <div class="team-img">
                                    <img src="{{ asset('build/assets/images/users/13.jpg') }}" class="rounded-circle"
                                        alt="img">
                                </div>
                            </div>
                            <div class="text-center mt-2">
                    ...
                    <div class="card shadow-none">
                        <div class="card-body text-center py-6">
                            <div class="avatar avatar-xl bg-primary rounded-4">
                                <svg xmlns="http://www.w3.org/2000/svg" height="35px" width="35px" fill="#fff"
                                    viewBox="0 0 64 64" id="management">
                                    <path
                                    ...
                                    <path
                                        d="M52 11h2v2h-2zM52 15h2v2h-2zM7.293 11.707l1.414-1.414L7.414 9H13a1 1 0 0 1 1 1v10h2V10a3 3 0 0 0-3-3H7.414l1.293-1.293-1.414-1.414-3 3a1 1 0 0 0 0 1.414ZM14 22h2v2h-2zM14 26h2v2h-2z">
                                    </path>
                                    <path
                                        d="M10 11h2v2h-2zM10 15h2v2h-2zM26.293 32.293l-3 3 1.414 1.414L26 35.414V43h2v-7.586l1.293 1.293 1.414-1.414-3-3a1 1 0 0 0-1.414 0ZM26 45h2v2h-2zM26 49h2v2h-2zM40.707 35.293l-3-3a1 1 0 0 0-1.414 0l-3 3 1.414 1.414L36 35.414V43h2v-7.586l1.293 1.293ZM36 45h2v2h-2zM36 49h2v2h-2z">
                                    </path>
                                </svg>
                            </div>
                            <div class="mt-3">
                ...
                <div class="col-xl-3">
                    <div class="card shadow-none">
                        <div class="card-body text-center py-6">
                            <div class="avatar avatar-xl bg-primary rounded-4">
                                <svg xmlns="http://www.w3.org/2000/svg" height="35px" width="35px" fill="#fff"
                                    enable-background="new 0 0 32 32" viewBox="0 0 32 32" id="design-tools">
                                    <path d="M27.4,12.2C27.5,12.2,27.5,12.2,27.4,12.2L31,3c0.1-0.2,0-0.4-0.1-0.5c-0.1-0.1-0.4-0.2-0.5-0.1l-9.2,3.5c0,0,0,0,0,0
                                                            ...
                                                            c0.3,0.7,0.9,1.3,1.6,1.6l-2,5.2H25z"></path>
                                </svg>
                            </div>
                            <div class="mt-3">
                ...
                <div class="col-xl-3">
                    <div class="card shadow-none">
                        <div class="card-body text-center py-6">
                            <div class="avatar avatar-xl bg-primary rounded-4">
                                <svg xmlns="http://www.w3.org/2000/svg" height="35px" width="35px" fill="#fff"
                                    viewBox="0 0 1024 1024" id="support">
                                    <path
                ...
                <div class="about-footer rounded-3">
                    <div class="row justify-content-center mb-4">
                        <div class="col-xl-6 my-5 text-center">
                            <h6 class="tx-fixed-white fw-semibold">Feel free to communicate with our team faster and easier
                                way. Want to get in ?</h6>
