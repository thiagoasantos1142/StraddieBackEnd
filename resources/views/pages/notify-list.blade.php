                                ...
                                <div class="container">
                                    <ul class="notification">
                                            ...
                                            <div class="notification-body">
                                                <div class="media mt-0">
                                                    <div class="main-avatar avatar-md online">
                                                        <img alt="avatar" class="rounded-circle" src="{{asset('build/assets/images/users/1.jpg')}}">
                                                    </div>
                                            ...
                                            <div class="notification-body">
                                                <div class="media mt-0">
                                                    <div class="main-avatar avatar-md offline">
                                                        <span class="avatar avatar-md rounded-circle bg-secondary me-3">ED</span>
                                                    </div>
                                                    <div class="media-body ms-3 d-flex">
                                                        <div class="">
                                        ...
                                        <li>
                                            ...
                                            <div class="notification-icon">
                                                <a href="javascript:void(0);" class="border-success"></a>
                                            </div>
                                            <div class="notification-time-date mb-2 d-block d-md-none">
                                                <span class="date">Yesterday</span>
                                        ...
                                        <li>
                                            ...
                                            <div class="notification-icon">
                                                <a href="javascript:void(0);" class="border-info"></a>
                                            </div>
                                            <div class="notification-time-date mb-2 d-block d-md-none">
                                                <span class="date">23 Oct</span>
                                        ...
                                        <li>
                                            ...
                                            <div class="notification-icon">
                                                <a href="javascript:void(0);" class="border-warning"></a>
                                            </div>
                                            <div class="notification-time-date mb-2 d-block d-md-none">
                                                <span class="date">15 Oct</span>
                                            ...
                                            <div class="notification-body">
                                                <div class="media mt-0">
                                                    <div class="main-avatar avatar-md offline">
                                                        <span class="avatar avatar-md rounded-circle me-3 bg-warning">IH</span>
                                                    </div>
                                                    <div class="media-body ms-3 d-flex">
                                                        <div class="">
                                        ...
                                        <li>
                                            ...
                                            <div class="notification-icon">
                                                <a href="javascript:void(0);" class="border-danger"></a>
                                            </div>
                                            <div class="notification-time-date mb-2 d-block d-md-none">
                                                <span class="date">30 Sep</span>
                                        ...
                                        <li>
                                            ...
                                            <div class="notification-icon">
                                                <a href="javascript:void(0);" class="border-pink"></a>
                                            </div>
                                            <div class="notification-time-date mb-2 d-block d-md-none">
                                                <span class="date">18 Sep</span>
                                            ...
                                            <div class="notification-body">
                                                <div class="media mt-0">
                                                    <div class="main-avatar avatar-md online">
                                                        <img alt="avatar" class="rounded-circle" src="{{asset('build/assets/images/users/4.jpg')}}">
                                                    </div>
                                                    <div class="media-body ms-3 d-flex">
                                                        <div class="">
                                        ...
                                        <li>
                                            ...
                                            <div class="notification-icon">
                                                <a href="javascript:void(0);" class="border-orange"></a>
                                            </div>
                                            <div class="notification-time-date mb-2 d-block d-md-none">
                                                <span class="date">03 Sep</span>
                                        ...
                                        <li>
                                            ...
                                            <div class="notification-icon">
                                                <a href="javascript:void(0);" class="border-purple"></a>
                                            </div>
                                            <div class="notification-time-date mb-2 d-block d-md-none">
                                                <span class="date">28 Aug</span>
                                            ...
                                            <div class="notification-body">
                                                <div class="media mt-0">
                                                    <div class="main-avatar avatar-md online">
                                                        <span class="avatar avatar-md rounded-circle me-3 bg-purple">IH</span>
                                                    </div>
                                                    <div class="media-body ms-3 d-flex">
                                                        <div class="">
