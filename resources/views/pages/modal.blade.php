                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <div class="card-content btn-list">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#inputModal" data-bs-whatever="@mdo">Open modal for @mdo</button>
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#inputModal" data-bs-whatever="@fat">Open modal for @fat</button>
                            <button type="button" class="btn btn-primary text-start" data-bs-toggle="modal"
                                data-bs-target="#inputModal" data-bs-whatever="@getbootstrap">Open modal for
                                @getbootstrap</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <div class="card-content btn-list">
                            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#smallmodal">Small
                                Modal</button>
                            <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#largemodal">large
                                Modal</button>
                            <button class="btn btn-secondary" data-bs-toggle="modal"
                                data-bs-target="#extralargemodal">Extralarge Modal</button>
                            <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#scrollingmodal">Scrolling
                                Modal</button>
                    ...
                    <div class="card-body">
                        <div class="row ">
                            <div class="col-sm-6 col-md-6 col-xl-3">
                                <a class="modal-effect btn btn-outline-primary d-grid mb-3" data-bs-effect="effect-scale"
                            ...
                            <div class="col-sm-6 col-md-6 col-xl-3">
                                <a class="modal-effect btn btn-outline-success d-grid mb-3" data-bs-effect="effect-fall"
                            ...
                            <div class="col-sm-6 col-md-6 col-xl-3">
                                <a class="modal-effect btn btn-outline-primary d-grid mb-3"
                                    data-bs-effect="effect-flip-vertical" data-bs-toggle="modal" href="#modaldemo8">Flip
                                    Vertical</a>
                            </div>
                            <div class="col-sm-6 col-md-6 col-xl-3">
                                <a class="modal-effect btn btn-outline-secondary d-grid mb-3"
                                    data-bs-effect="effect-super-scaled" data-bs-toggle="modal" href="#modaldemo8">Super
                                    Scaled</a>
                            </div>
                            <div class="col-sm-6 col-md-6 col-xl-3">
                                <a class="modal-effect btn btn-outline-danger d-grid mb-3" data-bs-effect="effect-sign"
                            ...
                            <div class="col-sm-6 col-md-6 col-xl-3">
                                <a class="modal-effect btn btn-outline-success d-grid mb-3"
                                    data-bs-effect="effect-rotate-left" data-bs-toggle="modal" href="#modaldemo8">Rotate
                                    Left</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card shadow-none text-start bg-secondary-transparent border-start border-secondary">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <span class="me-3"><svg xmlns="http://www.w3.org/2000/svg" height="30"
                                        width="30" viewBox="0 0 24 24">
                                        <path fill="#f07f8f"
