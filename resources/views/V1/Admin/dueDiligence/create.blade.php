                                ...
                                <div class="card custom-card">
                                    <div class="card-header d-sm-flex d-block">
                                        <ul class="nav nav-pills nav-tabs-header mb-0 d-sm-flex d-block" role="tablist">
                                            ...
                                            <li class="nav-item m-1">
                                                ...
                                                href="#title-settings" aria-selected="true">Advogados</a>
                                            </li>
                                            <li class="nav-item m-1">
                                                <a class="nav-link" data-bs-toggle="tab" role="tab" aria-current="page"
                                                href="#lawyer-settings" aria-selected="true">Informações Sobre o titulo</a>
                                            </li>
                                            <li class="nav-item m-1">
                                                <a class="nav-link" data-bs-toggle="tab" role="tab" aria-current="page"
                                    ...
                                    <div class="card-body p-0">
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fs-13 p-5" id="title-settings" role="tabpanel">
                                            ...
                                            <div class="tab-pane fs-13 p-0" id="lawyer-settings" role="tabpanel">
                                            <div class="row gy-3">                                                     
                                                        <div class="col-xl-7">
                                                            <div class="card custom-card shadow-none mb-0 border">
                                                                <div class="card-body">
