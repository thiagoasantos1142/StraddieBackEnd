                                ...
                                <div class="card custom-card">
                                    <div class="card-header d-sm-flex d-block">
                                        <ul class="nav nav-pills nav-tabs-header mb-0 d-sm-flex d-block" role="tablist">
                                            ...
                                            <li class="nav-item m-1">
                                                <a class="nav-link" data-bs-toggle="tab" role="tab" aria-current="page"
                                                href="#security" aria-selected="true">Destaques</a>
                                            </li>
                                        </ul>
                                    </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-10">
                                                                                ...
                                                                                <label class="custom-switch d-block mb-2">
                                                                                    <input type="checkbox" name="custom-switch-checkbox" class="custom-switch-input" checked>
                                                                                    <span class="custom-switch-indicator"></span>
                                                                                    <span class="text-muted ms-2">Procuração</span>
                                                                                </label>
                                                                                <label class="custom-switch d-block mb-2">
                                                                                    ...
                                                                                    <span class="custom-switch-indicator"></span>
                                                                                    <span class="text-muted ms-2">Certidão Negativa de Débitos Municipais</span>
                                                                                </label>
                                                                                <label class="custom-switch d-block mb-2">
                                                                                    <input type="checkbox" name="custom-switch-checkbox11" class="custom-switch-input" checked>
                                                                                    <span class="custom-switch-indicator"></span>
                                                                                    <span class="text-muted ms-2">Certidão Negativa de Débitos Estaduais</span>
                                                                                </label>
                                                                                <label class="custom-switch d-block mb-2">
                                                                                    <input type="checkbox" name="custom-switch-checkbox11" class="custom-switch-input" checked>
                                                                                    <span class="custom-switch-indicator"></span>
                                                                                    <span class="text-muted ms-2">Certidão Negativa de Débitos Federais </span>
                                                                                </label>              
                                                                            </div>                                                    
                                                                        </div>
                                                                    </div>    
                                                                    ...
                                                                    <ul class="list-group">
                                                                        <li class="list-group-item">
                                                                            <div class="d-flex align-items-top">
                                                                                ...
                                                                                <div class="lh-1 flex-fill">
                                                                                    <p class="mb-1">
                                                                                        <span class="fw-semibold">Documento de identificação</span>
                                                                                        <div class="d-sm-flex align-items-center">
                                                                                            <div>                                                                                                
                                                                                                <p class="card-text  text-muted">Documento Aprovado</p>
                                                                                            </div>
                                                                                        </div>
                                                                                    </p>
                                                                        ...
                                                                        <li class="list-group-item">
                                                                            <div class="d-flex align-items-top">
                                                                                ...
                                                                                <div class="lh-1 flex-fill">
                                                                                    <p class="mb-1">
                                                                                        <span class="fw-semibold">Selfie com o documento</span>
                                                                                    </p>
                                                                                    <p class="mb-0">
                                                                                        <span class="text-muted fs-11">Aguardando envio</span>
                                                                                    </p>
                                                                                </div>
                                                                                <div class="dropdown mt-sm-0 mt-2">
                                                                                    <a href="#" class="btn btn-icon btn-sm btn-light" data-bs-toggle="dropdown" aria-expanded="false">
                                                                        ...
                                                                        <li class="list-group-item">
                                                                                ...
                                                                                <div class="card-body d-flex justify-content-between align-items-center flex-wrap gap-1">
                                                                                    <div class="d-sm-flex align-items-center">
                                                                                        ...
                                                                                        <div>
                                                                                            <h4 class="h4 mb-0">Procuração</h4>
                                                                                            <p class="card-text  text-muted">Enviado, aguardando aprovação</p>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="text-end">
                                                                                        <a href="javascript:void(0);" class="btn btn-white me-2 mb-2">Visualizar</a>
                                                                                        <a href="javascript:void(0);" class="btn btn-success me-2 mb-2">Aprovar</a>                                                                                        
                                                                                        <a href="javascript:void(0);" class="btn btn-danger me-2 mb-2">Rejeitar</a>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <li class="list-group-item">
                                                                            <div class="d-flex align-items-top">
                                                                                ...
                                                                                <div class="lh-1 flex-fill">
                                                                                    <p class="mb-1">
                                                                                        <span class="fw-semibold">Comprovante de Endereço</span>
                                                                                    </p>
                                                                                    <p class="mb-0">
                                                                                        <span class="text-muted fs-11 text-wrap">Documento Rejeitado</span>
                                                                                    </p>
                                                                                </div>
                                                                                <div class="dropdown mt-sm-0 mt-2">
                                                                                    <a href="#" class="btn btn-icon btn-sm btn-light" data-bs-toggle="dropdown" aria-expanded="false">
                                                                        ...
                                                                        <li class="list-group-item">
                                                                            <div class="d-flex align-items-top">
                                                                                ...
                                                                                <div class="lh-1 flex-fill">
                                                                                    <p class="mb-1">
                                                                                        <span class="fw-semibold">Certidão Negativa de Débitos Municipais</span>
                                                                                    </p>
                                                                                    <p class="mb-0">
                                                                                        <span class="text-muted fs-11">Aguardando envio</span>
                                                                                    </p>
                                                                        ...
                                                                        <li class="list-group-item">
                                                                            <div class="d-flex align-items-top">
                                                                                ...
                                                                                <div class="lh-1 flex-fill">
                                                                                    <p class="mb-1">
                                                                                        <span class="fw-semibold">Certidão Negativa de Débitos Estaduais</span>
                                                                                    </p>
                                                                                    <p class="mb-0">
                                                                                        <span class="text-muted fs-11">Aguardando envio</span>
                                                                                    </p>
                                                                        ...
                                                                        <li class="list-group-item">
                                                                            <div class="d-flex align-items-top">
                                                                                ...
                                                                                <div class="lh-1 flex-fill">
                                                                                    <p class="mb-1">
                                                                                        <span class="fw-semibold">Certidão Negativa de Débitos Federais</span>
                                                                                    </p>
                                                                                    <p class="mb-0">
                                                                                        <span class="text-muted fs-11">Aguardando envio</span>
                                                                                    </p>
                                                                    ...
                                                                    <div class="d-sm-flex d-block align-items-top mb-4 justify-content-between">
                                                                        <div>
                                                                            ...
                                                                            @if($lawyer->user)
                                                                                ...
                                                                                <p class="fs-12 text-muted mb-0">Nome: {{$lawyer->user->cpf}}</p>                                                                    
                                                                                <p class="fs-12 text-muted mb-0">Nome: {{$lawyer->user->contacts[1]->phone}}</p>                                                                    
                                                                                <p class="fs-12 text-muted mb-0">Nome: {{$lawyer->user->email}}</p> 
                                                                            @else   
